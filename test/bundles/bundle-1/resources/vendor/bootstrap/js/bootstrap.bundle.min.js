      ...
      modifiers: {
              ...
              d = {
                ...
                secondary: function (t) {
                  var n = 'right' === t ? 'left' : 'top',
                    i = f[n];
                  return (
                    f[t] > l[t] && !e.escapeWithReference && (i = Math.min(f[n], l[t] - ('right' === t ? f.width : f.height))), z({}, n, i)
                  );
                },
              };
            return (
        ...
        inner: {
          ...
          fn: function (t) {
            ...
            return (
              (o[a ? 'left' : 'top'] = r[n] - (s ? o[a ? 'width' : 'height'] : 0)), (t.placement = at(e)), (t.offsets.popper = K(o)), t
            );
          },
        },
        hide: {
        ...
        (t._dataApiKeydownHandler = function (e) {
          if (
            !(/input|textarea/i.test(e.target.tagName)
              ? 32 === e.which ||
                (27 !== e.which && ((40 !== e.which && 38 !== e.which) || i.default(e.target).closest('.dropdown-menu').length))
              : !jt.test(e.which)) &&
            !this.disabled &&
      ...
      return (
        ...
        (e._fixTransition = function () {
          ...
          null === t.getAttribute('x-placement') &&
            (i.default(t).removeClass('fade'), (this.config.animation = !1), this.hide(), this.show(), (this.config.animation = e));
        }),
        (t._jQueryInterface = function (e) {
          return this.each(function () {
            var n = i.default(this),
