...
!(function (t, e) {
  ...
  N._set('global', {
    elements: { arc: { backgroundColor: N.global.defaultColor, borderColor: '#fff', borderWidth: 2, borderAlign: 'center' } },
  });
  var st = K.extend({
      _type: 'arc',
  ...
  var qe = K.extend({
      ...
      drawBody: function (t, e, n) {
        ...
        for (
          ...
          for (
            i = g[s], a = e.labelTextColors[s], r = e.labelColors[s], n.fillStyle = a, H.each(i.before, x), l = 0, d = (o = i.lines).length;
            l < d;
            ++l
          ) {
            if (p) {
  ...
  var xn = K.extend({
    ...
    _getLabelSizes: function () {
      ...
      return (
        e ||
          ((t._labelSizes = e = cn(t.ctx, mn(t.options.ticks), t.getTicks(), t.longestTextCache)), (t.longestLabelWidth = e.widest.width)),
        e
      );
    },
  ...
  var zn = yn.extend({
      ...
      handleTickRangeOptions: function () {
        ...
        (t.min = Rn(e.min, t.min)),
          ...
          null === t.minNotZero &&
            (t.min > 0 ? (t.minNotZero = t.min) : t.max < 1 ? (t.minNotZero = Math.pow(10, Math.floor(On(t.max)))) : (t.minNotZero = 1));
      },
      buildTicks: function () {
        var t = this,
          e = t.options.ticks,
        ...
        if (
          ...
          for (
            a.save(),
              ...
              a.strokeStyle = u,
              a.setLineDash &&
                (a.setLineDash(Wn([s.borderDash, o.borderDash, []])), (a.lineDashOffset = Wn([s.borderDashOffset, o.borderDashOffset, 0]))),
