...
!(function (t, e) {
  ...
  Y._set('global', {
    elements: { arc: { backgroundColor: Y.global.defaultColor, borderColor: '#fff', borderWidth: 2, borderAlign: 'center' } },
  });
  var lt = X.extend({
      _type: 'arc',
      ...
      inRange: function (t, e) {
        var n = this._view;
        if (n) {
          for (var i = B.getAngleFromPoint(n, { x: t, y: e }), a = i.angle, r = i.distance, o = n.startAngle, s = n.endAngle; s < o; )
            s += rt;
          for (; a > s; ) a -= rt;
          for (; a < o; ) a += rt;
          var l = a >= o && a <= s,
        ...
        if (s.length) {
          ...
          for (
            ...
            (n = s[t]._view),
              ...
              n.skip || ((d !== t - 1 && !o) || -1 === d ? r.moveTo(n.x, n.y) : B.canvas.lineTo(r, e._view, n), (d = t));
    ...
    var i,
      ...
      l = (function (t) {
        var e = t.borderSkipped,
          n = {};
        return e
          ? (t.horizontal ? t.base > t.x && (e = yt(e, 'left', 'right')) : t.base < t.y && (e = yt(e, 'bottom', 'top')), (n[e] = !0), n)
          : n;
      })(t);
    return (
      ...
      return n && n.canvas === t
        ? (this._ensureLoaded(t),
          (function (t, e) {
            ...
            if (
              ((t[be] = { initial: { height: i, width: a, style: { display: n.display, height: n.height, width: n.width } } }),
  ...
  var Ue = X.extend({
      ...
      drawBody: function (t, e, n) {
        ...
        for (
          ...
          for (
            i = g[s], a = e.labelTextColors[s], r = e.labelColors[s], n.fillStyle = a, B.each(i.before, y), l = 0, d = (o = i.lines).length;
            l < d;
            ++l
          ) {
            if (m) {
  ...
  var xn = X.extend({
    ...
    _getLabelSizes: function () {
      ...
      return (
        e ||
          ((t._labelSizes = e = fn(t.ctx, vn(t.options.ticks), t.getTicks(), t.longestTextCache)), (t.longestLabelWidth = e.widest.width)),
        e
      );
    },
      ...
      getPixelForValue: function (t, e, n) {
        ...
        return (
          ...
          (void 0 !== i || (void 0 !== t && isNaN(e))) &&
            ((a = o._getLabels()), (t = B.valueOrDefault(i, t)), (e = -1 !== (r = a.indexOf(t)) ? r : e), isNaN(e) && (e = t)),
  ...
  var Wn = _n.extend({
      ...
      handleTickRangeOptions: function () {
        ...
        (t.min = Nn(e.min, t.min)),
          ...
          null === t.minNotZero &&
            (t.min > 0 ? (t.minNotZero = t.min) : t.max < 1 ? (t.minNotZero = Math.pow(10, Math.floor(Ln(t.max)))) : (t.minNotZero = 1));
      },
      buildTicks: function () {
        var t = this,
          e = t.options.ticks,
        ...
        if (
          ...
          for (
            a.save(),
              ...
              a.strokeStyle = u,
              a.setLineDash &&
                (a.setLineDash(Vn([s.borderDash, o.borderDash, []])), (a.lineDashOffset = Vn([s.borderDashOffset, o.borderDashOffset, 0]))),
  ...
  var ci = _n.extend({
      ...
      getPixelForValue: function (t, e, n) {
        var i = null;
        if ((void 0 !== e && void 0 !== n && (i = this._timestamps.datasets[n][e]), null === i && (i = ui(this, t)), null !== i))
