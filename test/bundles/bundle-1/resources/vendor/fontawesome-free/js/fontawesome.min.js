...
!(function () {
  ...
  function jt(t) {
    ...
    m && (w.attributes[tt] = ''),
      s &&
        w.children.push({ tag: 'title', attributes: { id: w.attributes['aria-labelledby'] || 'title-'.concat(f || kt()) }, children: [s] });
    var k,
      A,
      C,
      O,
      ...
      X,
      B,
      G = $({}, w, { prefix: r, iconName: i, main: n, mask: a, maskId: l, transform: o, symbol: c, styles: $({}, x, u.styles) }),
      J =
        a.found && n.found
          ? ((C = (k = G).children),
            (O = k.attributes),
            ...
            (D = {
              tag: 'defs',
              children: [{ tag: 'clipPath', attributes: { id: H }, children: ((A = L), 'g' === A.tag ? A.children : [A]) }, U],
            }),
            C.push(D, {
              tag: 'rect',
    ...
    return {
      ...
      icon: Array.isArray(a)
        ? {
            ...
            children: [
              { tag: 'path', attributes: { class: ''.concat(et.familyPrefix, '-').concat(F.SECONDARY), fill: 'currentColor', d: a[0] } },
              { tag: 'path', attributes: { class: ''.concat(et.familyPrefix, '-').concat(F.PRIMARY), fill: 'currentColor', d: a[1] } },
            ],
          }
              ...
              Object.keys(r).forEach(function (t) {
                (e.definitions[t] = $({}, e.definitions[t] || {}, r[t])),
                  (function t(e, a) {
                    ...
                    'function' != typeof W.hooks.addPack || r ? (W.styles[e] = $({}, W.styles[e] || {}, i)) : W.hooks.addPack(e, i),
                      'fas' === e && t('fa', a);
                  })(t, r[t]),
                  Vt();
              });
    ...
    _e = {
      ...
      watch: function () {
        ...
        !1 === et.autoReplaceSvg && (et.autoReplaceSvg = !0),
          ...
          V(function () {
            Ye({ autoReplaceSvgRoot: e }), ce({ treeCallback: ke, nodeCallback: Ae, pseudoElementsCallback: Se, observeMutationsRoot: n });
          });
      },
    },
    Te =
