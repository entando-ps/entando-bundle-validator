...
(function (h) {
      ...
      G = function (a) {
        if (c === k || c === i)
          (j = l[i]),
            (h = a.innerHTML.trim()),
            j && j._bAttrSrc
              ? (N(j.mData._)(d, h), u(j.mData.sort, a), u(j.mData.type, a), u(j.mData.filter, a))
              : q
  ...
  function Ja(a, b, c, d) {
    ...
    if (null === e.nTr) {
      ...
      for (q = a.aoColumns.length; l < q; l++) {
        ...
        g.push(i);
        if (k || ((!c || m.mRender || m.mData !== l) && (!h.isPlainObject(m.mData) || m.mData._ !== l + '.display')))
    ...
    for (c = l.length; b < c; b++)
      (f = l[b]),
        ...
        a.oFeatures.bSort &&
          ...
          !1 !== f.bSortable && (d.attr('tabindex', a.iTabIndex).attr('aria-controls', a.sTableId), Oa(a, f.nTh, b))),
  ...
  function wb(a) {
    ...
    for (g = 0; g < c; g++)
      (m = b[g]),
        ...
        u('mDataProp_' + g, i),
        d.bFilter && (u('sSearch_' + g, l.sSearch), u('bRegex_' + g, l.bRegex), u('bSearchable_' + g, m.bSearchable)),
  ...
  function rb(a) {
    var b = a.oClasses,
      ...
      i = function () {
        ...
        b != e.sSearch &&
          (ha(a, { sSearch: b, bRegex: e.bRegex, bSmart: e.bSmart, bCaseInsensitive: e.bCaseInsensitive }), (a._iDisplayStart = 0), P(a));
      },
  ...
  function Ha(a) {
    ...
    if (d || (!u && !f && !e && j == W(a) && j == m.length))
      for (n = 0; n < j; n++) (i = ba(a, n)), null !== i && (c[i].sWidth = w(m.eq(n).width()));
    else {
      ...
      for (n = 0; n < i.length; n++)
        (o = c[i[n]]),
          (m[n].style.width = null !== o.sWidthOrig && '' !== o.sWidthOrig ? w(o.sWidthOrig) : ''),
    ...
    if ('ssp' != y(a) && 0 !== h.length) {
      ...
      g === h.length
        ...
        : i.sort(function (a, b) {
            ...
            for (j = 0; j < k; j++)
              if (
                ((i = h[j]), (c = n[i.col]), (g = o[i.col]), (i = e[i.type + '-' + i.dir] || e['string-' + i.dir]), (c = i(c, g)), 0 !== c)
              )
                return c;
            c = d[a];
            g = d[b];
    ...
    var d,
      ...
      b = function (b) {
        if (b && b.time) {
          ...
          if (
            -1 === h.inArray(!1, g) &&
            ((g = a.iStateDuration), !(0 < g && b.time < +new Date() - 1e3 * g) && !(b.columns && f.length !== b.columns.length))
          ) {
  ...
  function ja(a, b) {
    ...
    b <= c
      ...
      : (a >= b - 1 - d ? (c = Z(b - (c - 2), b)) : ((c = Z(a - d + 2, a + d - 1)), c.push('ellipsis'), c.push(b - 1)),
      ...
      d = this.iterator(
        ...
        function (a, b) {
          ...
          for (j = f[b].length; g < j; g++) {
            i = 0;
            for (m = e[b].length; i < m; i++) c.push({ row: f[b][g], column: e[b][i] });
          }
          return c;
        },
        1
  ...
  n.defaults = {
    ...
    fnStateLoadCallback: function (a) {
      try {
        return JSON.parse(
          (a.iStateDuration === -1 ? sessionStorage : localStorage).getItem('DataTables_' + a.sInstance + '_' + location.pathname)
        );
      } catch (b) {
        return {};
      }
